...
function test() {
	...
	console.assert(makeMove('D1', 'D5') !== false, 'Queen can move arbitrarily forward');
	console.assert(makeMove('G5', 'G4') !== false, 'Black pawn moves');
	console.assert(makeMove('C1', 'G5') !== false, 'Bishop can attack');
